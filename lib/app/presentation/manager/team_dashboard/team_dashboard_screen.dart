...
class TeamDashboardScreen extends AppWidget<TeamDashboardNotifier, void, void> {
  TeamDashboardScreen({super.key}) : super(param1: null, param2: null);

  @override
  Widget bodyBuild(BuildContext context) {
    final prov = context.watch<TeamDashboardNotifier>();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          title: const Text("Dashboard Tim",
  ...
  Widget _buildWelcomeCard(TeamDashboardNotifier prov, ThemeData theme) =>
      Container(
          ...
          child: Row(children: [
            Expanded(
                child: Column(
                  ...
                  Text(prov.stats?.user.name ?? "Manager",
