...
class LeaveApprovalScreen extends AppWidget<LeaveApprovalNotifier, void, void> {
  LeaveApprovalScreen({super.key}) : super(param1: null, param2: null);

  @override
  Widget bodyBuild(BuildContext context) {
    final prov = context.watch<LeaveApprovalNotifier>();
  ...
  Widget _buildFilterTabs(LeaveApprovalNotifier prov, ThemeData theme) {
    return Container(
      height: 50,
      ...
      child: Row(
        children: [
          ...
          Expanded(
              child: _buildFilterChip("Disetujui", "APPROVED", prov, theme)),
          const SizedBox(width: 8),
  ...
  Widget _buildFilterChip(
      String label, String value, LeaveApprovalNotifier prov, ThemeData theme) {
  ...
  Widget _buildApprovalCard(BuildContext context, LeaveEntity item,
      LeaveApprovalNotifier prov, ThemeData theme) {
    return Container(
  ...
  void _onApprove(
      BuildContext context, int id, LeaveApprovalNotifier prov) async {
  ...
  void _showRejectDialog(
      BuildContext context, int id, LeaveApprovalNotifier prov) {
